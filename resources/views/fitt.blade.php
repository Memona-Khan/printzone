...
<div class="row con" style="padding-top:50px;" >
 ...
 <div class="row con">
  ...
  <div class="container-fluid skewedBox" style="background-color:white;">
      <div class="row">
          <div class="col-sm-5 con">	
              <br> <br><br> <br><br><br>
        <h1 class="blck">CAR BRANDING</h1>
     </div>
     <div class="col-sm-7">
     <div class="con">
  <img src="fitting/car1.png" class="img-fluid" style="width:500px;height:330px;">	
 </div>
 </div>
 </div>
        </div>
  ...
  <div class="col-sm-7 con">	
   <img src="fitting/vision1.png" class="img-fluid" style="width:440px;height:330px;">	
  </div>
  <div class="col-sm-5">
 <div class="con">
<br><br>
...
<h1>Vision Pasting</h1>			
 ...
 <div class="col-sm-5">
   <div class="con">
       <br><br><br>
    <h1 style="color:white;">Vinyl Pasting</h1>			
 </div>
    </div>
 <div class="col-sm-7 con">	
    <img src="fitting/vinyl1.jpg" class="img-fluid" style="width:550px;height:330px;">	
 ...
 <div class="container-fluid skewedBox" style="background-color:white">
  <div class="row">
          ...
          <div class="col-sm-7 con" style="color:black;">	
              <img src="fitting/board1.png" class="img-fluid" style="width:470px;height:330px;">	
 </div>  <div class="col-sm-5">
    <div class="con">
         <br> <br><br><br><br><br><br>
          <h1 class="blck">BOARD FITTING</h1>			
                         </div>
                     </div>
...
<h1>BILL BOARDS</h1>			
 ...
 <div class="col-sm-7 con" style="color:black;">	
   <img src="fitting/bill2.png" class="img-fluid" style="width:500px;height:340px;">	
</div>
 </div>
 </div>
