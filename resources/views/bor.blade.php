...
font-size: 60px;
      ...
      <div class="container-fluid skewedBox" style="background-color:white;">
        <div class="row">
            <div class="col-sm-4">
                        <div class="con">
                        <br>
                   			<h1 class="blck">FRONT LIT BOARD</h1>			
                </div>
            </div>
    <div class="col-sm-8 con" style="color:black;">	
        <img src="boards/front1.jpg" class="img-fluid" width="400px">	
        ...
        <div class="row">
            <div class="col-sm-8">
                        <div class="con">
                          <img src="boards/back2.jpg" class="img-fluid" width="400px">	
 ...
 <div class="col-sm-8 con" >	
    <img src="boards/led1.jpg" class="img-fluid" width="400px">	
