      ...
      <div class="container-fluid skewedBox" style="background-color:white;">
        <div class="row">
            <div class="col-sm-5">
                        <div class="con">
                        <br> <br>
                   			<h1 style="color:black;">STAR PRINTING</h1>			
                </div>
            </div>
    <div class="col-sm-7 con" style="color:black;">	
        <img src="panaflex/star3.png" class="img-fluid" style="width:470px;height:330px;">	

                </div>
                     </div>
        </div>
        <div class="container-fluid skewedBox" style="background-color:#e8c400;">
            <div class="row">
 
  <div class="col-sm-7 con">	
   <img src="panaflex/poll1.png" class="img-fluid" style="width:470px;height:330px;">	
  </div>
  <div class="col-sm-5">
 <div class="con">
<br><br>
...
<h1>POLL BANNERS</h1>			
 ...
 <div class="col-sm-5">
   <div class="con">
       <br><br><br>
    <h1 style="color:white;">BACK LIT PRINTING</h1>			
 </div>
    </div>
 <div class="col-sm-7 con">	
    <img src="panaflex/back1.jpg" class="img-fluid" style="width:470px;height:330px;">	
 ...
 <div class="container-fluid skewedBox" style="background-color:white">
  <div class="row">
      <div class="col-sm-7">
                  <div class="con">
                  <img src="panaflex/vision1.jpg" class="img-fluid" style="width:470px;height:330px;">	
...
<h1>REFLECTOR</h1>			
 ...
 <div class="col-sm-7 con" style="color:black;">	
   <img src="panaflex/reflect1.jpg" class="img-fluid" style="width:470px;height:300px;">	
</div>
 </div>
 </div>
 <div class="container-fluid skewedBox" style="background-color:black">
  <div class="row">
      <div class="col-sm-7">
                  <div class="con">
                      <img src="panaflex/vinyl1.jpg" class="img-fluid" style="width:440px;height:300px;">	
...
<h1 class="blck">ROLAND PRINTING</h1>
</div>
<div class="col-sm-8">
 <div class="con">
 <img src="panaflex/roland1.jpg" class="img-fluid" style="width:420px;height:330px;">	
 </div>
  </div>
</div>
  </div>
 ...
 <img src="panaflex/x1.png" class="img-fluid" style="width:450px;height:370px;">	
 </div> 
  <div class="col-sm-4">
      <div class="con">
...
<h1> &nbsp;ROLL UP STAND</h1>
          ...
          <div class="col-sm-7">
              <div class="con"></div> <img src="panaflex/roll1.png" class="img-fluid" style="width:500px;height:370px;">	
 ...
 <div class="container-fluid skewedBox" style="background-color:white">
  <div class="row">
      <div class="col-sm-7">
                  <div class="con">
                      <img src="panaflex/elect1.jpg" class="img-fluid" style="width:380px;height:330px;">	
                     
          </div>
      </div>
<div class="col-sm-5 con">
  <br><br><br><br>	
<h1 class="blck">ELECTION CAMPAIGNS</h1>
          </div>
</div>
 </div> </div>
 <div class="container-fluid skewedBox" style="background-color:black">
